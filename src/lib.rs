...
const MATH_ALPHA_OVERRIDES: &[(u32, &str)] = &[
    ...
    (0x1D4D3, "D"),(0x1D4E3, "T"),(0x1D56D, "h"),(0x1D54B, "T"),(0x1D546, "O"),(0x1D53C, "E"),(0x1D57F, "T"),(0x1D57A, "H"),(0x1D570, "E"),
...
fn transliterate_internal(input: &str, policy: ErrorsPolicy<'_>) -> TransliterationResult {
    ...
    if (0xD800..=0xDFFF).contains(&cp) { char_index += 1; continue; }
